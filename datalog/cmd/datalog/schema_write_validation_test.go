...
func mustLoadConfig(t *testing.T, yamlText string) *mcpHandlers {
	...
	h, closeFn, err := newMCPHandlers(dir, schemaPath, nil, "", 5_000_000_000, defaultMaxFacts)
	if err != nil {
  ...
  - file: b.jsonl
    mappings:
      - predicate: eventB
        args: ["value.host"]
`)
	_, closeFn, err := newMCPHandlers(dir, schemaPath, nil, "", 5_000_000_000, defaultMaxFacts)
	if err != nil {
