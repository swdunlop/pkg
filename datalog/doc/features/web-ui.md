...
pretty-printed JSON, and — whenever the summary line truncated the
arguments — the full document, so elision never loses anything.
Error surfaces (the error lists, error transcript entries, error
